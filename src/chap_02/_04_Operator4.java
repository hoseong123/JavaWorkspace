...
public class _04_Operator4 {
    public static void main(String[] args) {
        ...
        System.out.println((5 < 3) || (3 < 1)); //5는 3보다 작거나, 3은 1보다 크다 false

        System.out.println(1 < 3 && 5 < 3); //괄호가 없어도 결과는 같다
        ...
        System.out.println(!(5 == 5)); // 5는 5와 같다의 반대 false
        System.out.println(!(5 == 3)); // 5는 3과 같다의 반대 true
